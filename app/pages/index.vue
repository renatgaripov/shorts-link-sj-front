        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div>
                <button
                    ...
                    @click="openModal2">Сократить ссылку</button>
            </div>
        </div>
...
<script setup lang="ts">
    ...
    const getAllLinks = async (searchQuery: string = '') => {
        loading.value = true;
        try {
            const res = await mainService.getAllLinks(searchQuery);

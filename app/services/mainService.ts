...
export default class MainService {
    private readonly baseUrl = 'https://short-link.socialjet.pro/api';
    ...
    public async getAllLinks(search?: string) {
        const endpoint = search ? `/short-link?q=${encodeURIComponent(search)}` : '/short-link';
